...
This project documents the practical networking work developed throughout and beyond my Cisco CCNA (200-301) certification journey. Rather than collecting isolated configuration examples, the goal is to build a structured series of labs that reflect real-world enterprise networking concepts.
...
## Getting Started
Cisco Packet Tracer is required to open and run the .pkt laboratory files included in this repository.

### **Cisco Packet Tracer can be downloaded free of charge from the official Cisco Networking Academy website after creating or signing in to a free Cisco account.**
